  ...
  <div class="register-branding">
    <div class="register-branding-content">
      <div class="brand-logo animate-fade-in">
        <img src="{{ asset('assets/img/logo/APNIPSYCHOLOGY-(dark).png') }}" alt="Apni Psychology" class="app-brand-logo" style="height: 80px; width: auto; max-width: 400px; background: transparent !important; object-fit: contain;">
      </div>
