        ...
        @forelse($experiences ?? [] as $index => $experience)
          <tr>
            ...
            <td>
              ...
              <form method="POST" action="{{ route('therapist.profile.experience.delete', $experience) }}" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this experience?')">
                @csrf
                @method('DELETE')
