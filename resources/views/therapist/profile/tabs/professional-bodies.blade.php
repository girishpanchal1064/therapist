        ...
        @forelse($professionalBodies ?? [] as $index => $body)
          <tr>
            ...
            <td>
              ...
              <form method="POST" action="{{ route('therapist.profile.professional-body.delete', $body) }}" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this professional body?')">
                @csrf
                @method('DELETE')
