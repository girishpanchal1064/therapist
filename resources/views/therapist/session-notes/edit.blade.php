...
<div class="page-header">
  <div class="d-flex justify-content-between align-items-center">
    <div>
      ...
      <p class="mb-0">Update session note details</p>
    </div>
...
<div class="card form-card">
  <div class="card-body p-4">
    <form action="{{ route('therapist.session-notes.update', $sessionNote->id) }}" method="POST">
      ...
      <div class="mb-4">
        <label for="appointment_id" class="form-label">Session ID</label>
      ...
      <div class="mb-4">
        <div class="form-check">
          ...
          <label class="form-check-label" for="user_didnt_turn_up">The User didn't turn up.</label>
        </div>
      </div>
      ...
      <div class="mb-4">
        <div class="form-check">
          ...
          <label class="form-check-label" for="no_follow_up_required">No Follow-up Required?</label>
        </div>
      </div>
