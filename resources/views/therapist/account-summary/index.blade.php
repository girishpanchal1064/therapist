      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4 align-items-end">
          <div>
            ...
            <form method="GET" action="{{ route('therapist.account-summary.index') }}" class="d-flex gap-2" id="dateRangeForm">
          ...
          <div class="flex-grow-1">
            <form method="GET" action="{{ route('therapist.account-summary.index') }}" class="d-flex gap-2">
              ...
              @if($search)
                <a href="{{ route('therapist.account-summary.index', ['start_date' => $startDate, 'end_date' => $endDate, 'per_page' => $perPage]) }}" class="btn btn-outline-secondary">
