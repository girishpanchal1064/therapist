    ...
    <div class="availability-page-header">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <p class="mb-0">Manage blocked slots for therapist: {{ $therapist->name }} ({{ $therapist->email }})</p>
        </div>
      </div>
    </div>
    ...
    <div class="card availability-main-card">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
          ...
          <p class="text-muted mb-0 small">Admin-managed blocked dates and time slots</p>
        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-buttons">
                        ...
                        <form method="POST" action="{{ route('admin.therapist-availability.block.toggle', $block) }}" class="d-inline">
                          @csrf
                        ...
                        <form method="POST" action="{{ route('admin.therapist-availability.block.destroy', $block) }}" class="d-inline delete-form">
                          @csrf
                          @method('DELETE')
