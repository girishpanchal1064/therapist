...
<style>
  ...
  .day-switch-item:hover {
    border-color: #647494;
    box-shadow: 0 2px 4px rgba(100, 116, 148, 0.15);
  }
  ...
  .form-switch .form-check-input:focus {
    border-color: #647494;
    outline: 0;
    box-shadow: 0 0 0 0.25rem rgba(100, 116, 148, 0.25);
  }
  ...
  #add-group:hover {
    transform: translateY(-1px);
    box-shadow: 0 4px 8px rgba(100, 116, 148, 0.2);
  }
    ...
    <div class="availability-page-header">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <p class="mb-0">Manage weekly schedule for therapist: {{ $therapist->name }} ({{ $therapist->email }})</p>
        </div>
      </div>
    </div>
    ...
    <div class="card availability-main-card">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
          ...
          <p class="text-muted mb-0 small">Admin-managed weekly recurring time slots</p>
        </div>
        <div class="d-flex align-items-center gap-2">
          <a href="{{ route('admin.therapist-availability.index') }}" class="btn btn-outline-secondary">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-buttons">
                        ...
                        <form method="POST" action="{{ route('admin.therapist-availability.set.destroy', $availability) }}" class="delete-form">
                          @csrf
                          @method('DELETE')
