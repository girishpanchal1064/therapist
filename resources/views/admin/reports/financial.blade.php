        ...
        <div class="card stats-card position-relative">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <i class="ri-calendar-line" style="font-size: 2.5rem; color: #647494; opacity: 0.3;"></i>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card stats-card position-relative">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <i class="ri-bank-line" style="font-size: 2.5rem; color: #647494; opacity: 0.3;"></i>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-2">
                                        @if($payment->user)
                                            ...
                                            @else
                                                <img src="https://ui-avatars.com/api/?name={{ urlencode($payment->user->name) }}&background=647494&color=fff&size=80&bold=true&format=svg" alt="{{ $payment->user->name }}" class="rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                                            @endif
                                        @endif
                                    </div>
