...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4><i class="ri-time-line me-2"></i>Pending Reviews</h4>
            <p>Review and moderate pending client reviews</p>
        </div>
        <a href="{{ route('admin.reviews.index') }}" class="btn btn-theme-outline">
            <i class="ri-arrow-left-line me-1"></i> All Reviews
        </a>
    </div>
</div>
        ...
        <div class="filter-card">
            <div class="d-flex flex-wrap gap-3 align-items-end">
                <div class="flex-grow-1">
                    <form method="GET" action="{{ route('admin.reviews.pending') }}" class="d-flex gap-2">
                        <input type="text" name="search" class="form-control" placeholder="Search by client, therapist, or comment..." value="{{ $search }}">
                        <button type="submit" class="btn btn-search">
                            <i class="ri-search-line"></i>
                        </button>
                        @if($search)
                            <a href="{{ route('admin.reviews.pending') }}" class="btn btn-outline-secondary">
                                ...
                                <div class="user-info">
                                    ...
                                    @elseif($review->client->getRawOriginal('avatar'))
                                        <img src="{{ asset('storage/' . $review->client->getRawOriginal('avatar')) }}" 
                                             ...
                                             class="user-avatar">
                                    @else
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($review->client->name) }}&background=647494&color=fff&size=80&bold=true&format=svg" 
                                             alt="{{ $review->client->name }}" 
                                             class="user-avatar">
                                    @endif
                                    <div>
