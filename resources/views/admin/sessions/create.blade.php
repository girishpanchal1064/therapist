        ...
        <form action="{{ route('admin.sessions.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('session_mode') is-invalid @enderror" 
                ...
                <option value="video" {{ old('session_mode') == 'video' ? 'selected' : '' }}>Video</option>
                <option value="audio" {{ old('session_mode') == 'audio' ? 'selected' : '' }}>Audio</option>
                <option value="chat" {{ old('session_mode') == 'chat' ? 'selected' : '' }}>Chat</option>
              </select>
              @error('session_mode')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('session_notes') is-invalid @enderror" 
                      id="session_notes" name="session_notes" rows="3">{{ old('session_notes') }}</textarea>
            @error('session_notes')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
