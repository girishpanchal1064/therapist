...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $appointmentStats = [
            ...
            'completed' => $therapist->appointmentsAsTherapist()->where('status', 'completed')->count(),
            'scheduled' => $therapist->appointmentsAsTherapist()->where('status', 'scheduled')->count(),
            'cancelled' => $therapist->appointmentsAsTherapist()->where('status', 'cancelled')->count(),
        ];
